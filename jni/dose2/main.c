...
int demoloop()
{
  ...
  f=(timex/1000.0/60.0)*132.3412*4;
  rundemo(f);
...
// This one moved here because of OSX oddities...
  ...
  if (MT) {
    thread = SDL_CreateThread(thread_func, lock);
    printf("Multithread version\n");
  }
