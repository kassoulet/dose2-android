...
void initdemo() {
  ...
  son     =obu2d_lue2("son.vec");
  luigi   =obu2d_lue2("luigi.vec");
  waitress=obu2d_lue2("weitross.vec");
  bitch   =obu2d_lue2("biaaccth.vec");
  onepiss =obu2d_lue2("onepiss.vec");
  tupiss  =obu2d_lue2("tupiss.vec");
  mfx     =obu2d_lue2("mfxlogo.vec");
//  mfx     =obu2d_lue2("t13.vec");
  hotel   =obu2d_lue2("hotel.vec");
  fok    =obu2d_lue2("fok.vec");
  knife   =obu2d_lue2("knaiv.vec");
  spoon   =obu2d_lue2("spuun.vec");
//  table   =obu2d_lue2("teibl.vec");
  sheets  =obu2d_lue2("shits.vec");
  malta   =obu2d_lue2("malta.vec");
  u2      =obu2d_lue2("u2.vec");
  u3      =obu2d_lue2("u3.vec");
  u4      =obu2d_lue2("u4.vec");
  u5      =obu2d_lue2("u5.vec");
  u6      =obu2d_lue2("u6.vec");
  u7      =obu2d_lue2("u7.vec");
  u8      =obu2d_lue2("u8.vec");
  u9      =obu2d_lue2("u9.vec");
  u10     =obu2d_lue2("u10.vec");
  u11     =obu2d_lue2("u11.vec");
  phone   =obu2d_lue2("phoyn.vec");
  manager =obu2d_lue2("manitsor.vec");
  resto   =obu2d_lue2("resto.vec");
  bed     =obu2d_lue2("bed.vec");
  dstairs =obu2d_lue2("dstairs.vec");
  plate   =obu2d_lue2("pleit.vec");
  toilet  =obu2d_lue2("toilet.vec");
  table   =obu2d_lue2("teibl2.vec");
  d2      =obu2d_lue2("2.vec");
  dose    =obu2d_lue2("dose.vec");
  italy   =obu2d_lue2("italy.vec");
  man1    =obu2d_lue2("man1.vec");
  man2    =obu2d_lue2("man2.vec");
  for (i=0; i<277; i++) {
    char s[399];
    sprintf(s, "j%04i.vec", (i&~1)+2);
...
/*  obu2d_draw(new_obu2d_morph(mfx, dose, .5), new_layer(cols5), 0, 
  ...
  //EKA SPIIKKIOSUUS VALMIS. �L� KOSKE!!!!!!!!!!!!!!!!!!!!!!!
  ...
  //TOKA SPIIKKIOSUUS VALMIS. �L� KOSKE!!!!!!!!!!!!!!!!!!!!!!!
